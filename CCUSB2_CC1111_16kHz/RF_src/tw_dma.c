...
extern UINT8  __xdata USB_fifo_all[6*ADC_SAMPLES];    // Audio data in USB format (48 samples, repeated three times)         
...
////////////////////////////////////////////////////////////////////////////////
/// @brief	This function configures DMA channel 3 to transfer ADC samples into the audioIn buffer
///
/// Sets the audioIn buffer as the destination address. The source address is NOT set, nor is 'SRCINC' field. 
/// These parameters must be set prior to the DMA request!
/// If a packet is sucessfully received, the source address should be set to the address of the 'payload' field of the RX Buffer.
/// If not, set the source address the adddress of "null", so as to mute the audio
///
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief	This function configures DMA channel 4 to transfer ADC samples to the USB_fifo_all buffer
///
/// Sets the USB_fifo_all buffer as the destination. The source address is NOT set, 
...
///////////////////////////////////////////////////////////////////////////////
/// @brief	This function configures DMA channel 0 to transfer data into the USB's USBF4 register
///             
/// The source address is NOT set, nor is the 'SRCINC' descriptor
/// These parameters must be set prior to enabling the DMA controller
///
////////////////////////////////////////////////////////////////////////////////
