#line 1 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_main.c"
...
#line 14 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_main.c"
#line 1 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\inc\\TLV320AIC3104.h"
...
#line 63 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\inc\\TLV320AIC3104.h"
...
#line 83 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\inc\\TLV320AIC3104.h"
...
#line 150 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\inc\\TLV320AIC3104.h"

#line 157 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\inc\\TLV320AIC3104.h"
...
#line 15 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_main.c"





const char channel[3][4] = {{ 0, 20,  4, 16},     
                            {74, 98, 78, 94},     
                            { 8, 82, 12, 90}};    
...
UINT8   __xdata activeOut = 0;              
UINT16  __xdata audioOut[2][96];   
...
void main(void) {
  ...
  do { if(0x00) { CLKCON |= 0x40; while(!(SLEEP & 0x20)); SLEEP |= 0x04; } else { SLEEP &= ~0x04; while(!(SLEEP & 0x40)); asm("NOP"); CLKCON &= ~0x47; SLEEP |= 0x04; } }while (0);
  do { CLKCON = ((CLKCON & ~0x07) | (0x00 & 0x07)); }while (0);
  CLKCON = (CLKCON & 0xC7);
  ...
  do { if (8==0){ RFTXRXIF = 0; } else if (8==1) { ADCIF = 0; } else if (8==2) { URX0IF = 0; } else if (8==3) { URX1IF = 0; } else if (8==4) { ENCIF_1 = ENCIF_0 = 0; } else if (8==5) { STIF = 0; } else if (8==6) { P2IF = 0; } else if (8==7) { UTX0IF= 0; } else if (8==8) { DMAIF = 0; } else if (8==9) { T1IF = 0; } else if (8==10) { T2IF = 0; } else if (8==11) { T3IF = 0; } else if (8==12) { T4IF = 0; } else if (8==13) { P0IF = 0; } else if (8==14) { UTX1IF= 0; } else if (8==15) { P1IF = 0; } else if (8==16) { (0) ? (S1CON |= 0x03) : (S1CON &= ~0x03); } else if (8==17) { WDTIF = 0; } } while (0);         
  ((unsigned char volatile __xdata *) 0)[0xDF40] |= 0x01;                        

  do{ DMA0CFGH = (BYTE)( (WORD)&DmaDesc0 >> 8 ); DMA0CFGL = (BYTE)( (WORD)&DmaDesc0 ); } while(0);          
  do{ DMA1CFGH = (BYTE)( (WORD)&DmaDesc1_4[0] >> 8 ); DMA1CFGL = (BYTE)( (WORD)&DmaDesc1_4[0] ); } while(0);  
  dmaMemtoMem(96);               
  initRf();                               
  dmaAudio();                             
  DMAIRQ = 0;
  do{ asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); DMAARM = ((0x01 << 4) & 0x1F); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); asm("NOP"); } while(0);                     

  macTimer3Init();

  do { if (9==0) { RFTXRXIE = 1; } else if (9==1) { ADCIE = 1; } else if (9==2) { URX0IE = 1; } else if (9==3) { URX1IE = 1; } else if (9==4) { ENCIE = 1; } else if (9==5) { STIE = 1; } else if (9==6) { (1) ? (IEN2 |= 0x02) : (IEN2 &= ~0x02); } else if (9==7) { (1) ? (IEN2 |= 0x04) : (IEN2 &= ~0x04); } else if (9==8) { DMAIE = 1; } else if (9==9) { T1IE = 1; } else if (9==10) { T2IE = 1; } else if (9==11) { T3IE = 1; } else if (9==12) { T4IE = 1; } else if (9==13) { P0IE = 1; } else if (9==14) { (1) ? (IEN2 |= 0x08) : (IEN2 &= ~0x08); } else if (9==15) { (1) ? (IEN2 |= 0x10) : (IEN2 &= ~0x10); } else if (9==16) { (1) ? (IEN2 |= 0x01) : (IEN2 &= ~0x01); } else if (9==17) { (1) ? (IEN2 |= 0x20) : (IEN2 &= ~0x20); } } while (0);            
  ...
  MAStxData.macPayloadLen = (1 + 96*2);
  MAStxData.macField = 0x73;

  while (1)  {        
    setChannel(channel[band][ActiveChIdx]);             
    ActiveChIdx = (ActiveChIdx + 1) & 0x03;
    
    do{RFST = 0x01;}while(0);           

    if ((P1 & 0x08) != aux_option_status) {             
      if ((P1 & 0x08) == 0) {                           
        I2Cwrite(0, 19, 0xFC);                 
        I2Cwrite(0, 17, 0x2F);            
        I2Cwrite(0, 15, 0x00);              
    ...
    while (audioFrameReady == 0);     
    
    audioFrameReady = 0;              



    do{ (DmaDesc0 . SRCADDRH) = ((BYTE) (((WORD)((audioOut[activeOut]))) >> 8)); (DmaDesc0 . SRCADDRL) = ((BYTE) ( (WORD)((audioOut[activeOut]))) ); }while(0);
    do{ (DmaDesc0 . DESTADDRH) = ((BYTE) (((WORD)((MAStxData . payload))) >> 8)); (DmaDesc0 . DESTADDRL) = ((BYTE) ( (WORD)((MAStxData . payload))) ); }while(0);
    DmaDesc0.SRCINC = 0x01;           
    DMAARM |= 0x01;
    DMAREQ |= 0x01;              
    while ((DMAARM & 0x01) > 0); 
