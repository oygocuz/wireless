#line 1 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_mac.c"
...
#line 15 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_mac.c"
...
void macsetT3TimeoutAndWait(UINT8 timeout, UINT8 multiplier) {
  ...
  for ( int i = 1; i <= multiplier; i++) {
    T3CC0 = timeout;            
    (T3CTL = (1) ? T3CTL|0x10 : T3CTL&~0x10);           

    while(!(TIMIF & 0x01));  

    TIMIF &= ~0x01;          
    (T3CTL = (0) ? T3CTL|0x10 : T3CTL&~0x10);          
  }
}
...
void setChannel (UINT8 ch) {
  ...
  while(((unsigned char volatile __xdata *) 0)[0xDF3B] != 0x01)
    if (((unsigned char volatile __xdata *) 0)[0xDF3B] == 0x11 || ((unsigned char volatile __xdata *) 0)[0xDF3B] == 0x16 || ((unsigned char volatile __xdata *) 0)[0xDF3B] == 0x0D) 
      do{RFST = 0x04;}while(0);
  
  ((unsigned char volatile __xdata *) 0)[0xDF06] = ch;
}
