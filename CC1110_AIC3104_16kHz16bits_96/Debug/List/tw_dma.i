#line 1 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_dma.c"
...
#line 14 "C:\\Users\\Chris\\Dropbox\\oygo\\wireless mic\\swra368\\CC1110_AIC3104_16kHz16bits_96\\src\\tw_dma.c"
...
__interrupt void dma_IRQ (void){
  ...
  if (DMAIRQ & 0x10) {     
    ...
    activeOut ^= 0x01;              
    if (activeOut == 0)
      do{ (DmaDesc1_4[3]. DESTADDRH) = ((BYTE) (((WORD)((audioOut[1]))) >> 8)); (DmaDesc1_4[3]. DESTADDRL) = ((BYTE) ( (WORD)((audioOut[1]))) ); }while(0);
    else 
      do{ (DmaDesc1_4[3]. DESTADDRH) = ((BYTE) (((WORD)((audioOut[0]))) >> 8)); (DmaDesc1_4[3]. DESTADDRL) = ((BYTE) ( (WORD)((audioOut[0]))) ); }while(0);
    audioFrameReady = 1;
...
void dmaToRadio(WORD length, WORD srcAddr){
   do{ (DmaDesc1_4[1]. SRCADDRH) = ((BYTE) (((WORD)((srcAddr))) >> 8)); (DmaDesc1_4[1]. SRCADDRL) = ((BYTE) ( (WORD)((srcAddr))) ); }while(0);   
   do{ (DmaDesc1_4[1]. DESTADDRH) = ((BYTE) (((WORD)((&((unsigned char volatile __xdata *) 0)[0xDFD9]))) >> 8)); (DmaDesc1_4[1]. DESTADDRL) = ((BYTE) ( (WORD)((&((unsigned char volatile __xdata *) 0)[0xDFD9]))) ); }while(0);  
   do{ (DmaDesc1_4[1]. LENH) = ((BYTE) (((WORD)((length))) >> 8)); (DmaDesc1_4[1]. LENL) = ((BYTE) ( (WORD)((length))) ); }while(0);            
   DmaDesc1_4[1].VLEN      = 0x00;                              
   DmaDesc1_4[1].PRIORITY  = 0x00;
   DmaDesc1_4[1].M8        = 0x00;       
   DmaDesc1_4[1].IRQMASK   = 0x00;     
   DmaDesc1_4[1].DESTINC   = 0x00;           
   DmaDesc1_4[1].SRCINC    = 0x01;            
                                                  
   DmaDesc1_4[1].TRIG      = 19;       
   DmaDesc1_4[1].TMODE     = 0x00;        
   DmaDesc1_4[1].WORDSIZE  = 0x00;       
...
void dmaAudio(void){
  ...
  do{ (DmaDesc1_4[3]. SRCADDRH) = ((BYTE) (((WORD)((&((unsigned char volatile __xdata *) 0)[0xDF42]))) >> 8)); (DmaDesc1_4[3]. SRCADDRL) = ((BYTE) ( (WORD)((&((unsigned char volatile __xdata *) 0)[0xDF42]))) ); }while(0);
  do{ (DmaDesc1_4[3]. DESTADDRH) = ((BYTE) (((WORD)((audioOut[0]))) >> 8)); (DmaDesc1_4[3]. DESTADDRL) = ((BYTE) ( (WORD)((audioOut[0]))) ); }while(0);
  DmaDesc1_4[3].VLEN       = 0x00;
  DmaDesc1_4[3].LENH       = 0;
  DmaDesc1_4[3].LENL       = 96;
  DmaDesc1_4[3].WORDSIZE   = 0x01;
  DmaDesc1_4[3].TMODE      = 0x00;
  DmaDesc1_4[3].TRIG       = 27;  
  DmaDesc1_4[3].SRCINC     = 0x00;
  DmaDesc1_4[3].DESTINC    = 0x01;
  DmaDesc1_4[3].IRQMASK    = 0x01;
  DmaDesc1_4[3].M8         = 0x00;
  DmaDesc1_4[3].PRIORITY   = 0x00;
...
void dmaMemtoMem(UINT8 length){
  ...
  DmaDesc0.WORDSIZE   = 0x01;
  DmaDesc0.TMODE      = 0x01;
  DmaDesc0.TRIG       = 0;       
  DmaDesc0.DESTINC    = 0x01;          
  DmaDesc0.IRQMASK    = 0x00;
  DmaDesc0.PRIORITY   = 0x00;
