...
#define DESC_TYPE_CS_ENDPOINT  0x25  ///< CS_ENDPOINT
//@}
...
#define DESC_TYPE_CS_INTERFACE 0x24  ///< Audio class-specific interface header
#define DESC_SUBTYPE_HEADER    0x01  ///< Audio CS_INTERFACE subtype of HEADER
#define DESC_SUBTYPE_INPUT_TERMINAL 0x02  ///< Audio CS_INTERFACE subtype INPUT_TERMINAL
#define DESC_SUBTYPE_FEATURE_UNIT   0x06  ///< Audio CS_INTERFACE subtype FEATURE_UNIT
#define DESC_SUBTYPE_OUTPUT_TERMINAL 0x03 ///< Audio CS_INTERFACE subtype OUTPUT_TERMINAL
#define DESC_SUBTYPE_AS_GENERAL 0x01 ///< Audio CS_INTERFACE subtype AS_GENERAL
#define DESC_SUBTYPE_FORMAT_TYPE 0x02 ///< Audio CS_INTERFACE subtype FOMAT_TYPE
#define DESC_SUBTYPE_EP_GENERAL 0x01  ///< Audio CS_ENDPOINT subtype EP_GENERAL
